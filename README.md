...
1. **Fiche_process** : Fichier texte conçu pour les collaborateurs d'une entreprise devant commander/comparer... du nouveau matériel pour un projet, leur expliquant la méthode à employer pour parvenir rapidement à trouver l'empreinte carbone d'un/+1 équipement(s) précis.

2. **Notebook.ipynb** : *Google Colaboratory Notebook* (Python) conçu pour une recherche rapide dans la base de données open source Boavizta sur l'empreinte carbone des équipements.
